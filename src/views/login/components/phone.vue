 ...
 * @LastEditors: yangdan
 * @LastEditTime: 2019-11-28 15:33:37
 * @Description: 添加描述
 -->
<template>
  <el-form :model="phoneForm" :rules="rules" ref="phoneForm" label-width="100px" class="bind-phone">
    <el-form-item prop="phone">
      <el-input v-model="phoneForm.phone" name="phone" placeholder="请输入手机号" autocomplete="on"></el-input>
    </el-form-item>
